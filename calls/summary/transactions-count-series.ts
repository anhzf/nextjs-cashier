...
interface TransactionCountsSeriesOptions {
  start: Date;
  end: Date;
...
export async function getSummaryOfTransactionsCountSeries({
  start, end, interval,
}: TransactionCountsSeriesOptions): Promise<TransactionsCount> {
